...
class Weather():
    ...
    def weather_report(self):
        ...
        self.data = requests.get(
            self.url+self.cityname+'&appid='+self.api_key).json()
    ...
    def __init__(self):
        ...
        self.date = Label(self.root, text=datetime.now().date(),
                          bg="#00274c", fg="white", font=self.font)
        self.date.place(x=400, y=5)

        self.heading = Label(self.root, text="Weather Report",
                             bg="#00274c", fg="white", font=self.font)
        self.heading.place(x=180, y=5)

        self.location = Label(self.root, text="NA-/",
                              bg="#00274c", fg="white", font=self.font)
        ...
        self.name = Label(self.root, text="City or Country Name",
        ...
        self.button = Button(self.root, text="Search", bg="#00274c", fg="white",
                             font=self.font, relief=RAISED, borderwidth=3, command=self.weather_report)
        ...
        self.report = Label(self.root, text="Weather Report",
                            bg="#00274c", fg="white", font=self.font, padx=10)
        ...
        self.weather = Label(self.root, text="NA/-",
                             fg="#00274c", font=self.font)
        ...
        self.temperature = Label(
            self.root, text="NA/-", fg="#00274c", font=self.font)
        ...
        self.humidity = Label(self.root, text="NA/-",
                              fg="#00274c", font=self.font)
        ...
        self.pressure = Label(self.root, text="NA/-",
                              fg="#00274c", font=self.font)
